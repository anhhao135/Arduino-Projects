...
void setup()
{
  ...
  uint32_t tStart=millis();
        // regular begin() using default settings and high speeed (1MHz on ESP8266, 400kHz on others)
  display.begin(1000000L, D2, D1);   // Only ESP8266: begin() using different speed and other GPIO pins (regular: SDA=GPIO4, SCL=GPIO5)
